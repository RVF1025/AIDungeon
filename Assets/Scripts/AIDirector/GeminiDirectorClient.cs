...
namespace AIDungeon.Director
{
    ...
    public class GeminiDirectorClient : MonoBehaviour
    {
        ...
        private const string ForkSystemInstruction =
            ...
            "각 문장을 마침표(.)·물음표(?)·느낌표(!)로 끊어라. 여러 문장이면 문장마다 문장부호를 붙이고 끝 문장도 반드시 문장부호로 끝맺어라. 예: '비겁한 발걸음이구나. 미지의 문으로 걸어라.' 또는 '숨 고르러 갈까? 히히!' 웃음소리·추임새(히히, 후후 등) 바로 앞의 문장에도 반드시 문장부호를 넣어라(예: '문을 열어볼까? 히히!').";
